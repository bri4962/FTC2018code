...
@Autonomous(name="AutoDepotCrater", group = "Auto")
public class AutoDepotCrater extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.elevatorMotor.setPower(0);
            ...
            DriveOnHeading(startAngle,60,.7,.06);
            robot.StopDriving();
            robot.marker.setPosition(0.7);
            sleep(2000);

            DriveOnHeadingBackwards(startAngle+50, 98,-.7,.06);
        robot.StopDriving();
